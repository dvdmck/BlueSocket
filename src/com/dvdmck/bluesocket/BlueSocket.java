...
public class BlueSocket extends Activity {
    
    private static final String TAG = "BLUESOCKET";
    private static final boolean D = true;
    private BluetoothAdapter mBluetoothAdapter = null;
    private BluetoothServerSocket servSocket = null;
    ...
    public void onResume() {
        ...
        /*try{
            servSocket = mBluetoothAdapter.listenUsingRfcommWithServiceRecord("Richies Ignition", MY_UUID);
            btSocket = servSocket.accept();
        }
        catch(Exception e){
